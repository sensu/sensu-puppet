...
if [ $? -ne 0 ]
then
    rpm --import https://yum.puppet.com/RPM-GPG-KEY-puppet-20250406
    rpm_install https://yum.puppet.com/puppet8-release-el-${release}.noarch.rpm
...
puppet module install puppetlabs/stdlib --version ">= 8.0.0 < 11.0.0"
