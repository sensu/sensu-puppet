...
describe Puppet::Type.type(:sensu_organization) do
  ...
  [
    ...
    it "should not accept invalid #{property}" do
      ...
      expect { organization }.to raise_error(Puppet::Error, /#{property.to_s} invalid/)
    end
  end
  ...
  [
    ...
    it "should not accept invalid #{property}" do
      config[property] = 'foo'
      expect { organization }.to raise_error(Puppet::Error, /Invalid value "foo". Valid values are true, false/)
    end
  end
