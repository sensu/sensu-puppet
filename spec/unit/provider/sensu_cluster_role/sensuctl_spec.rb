...
describe Puppet::Type.type(:sensu_cluster_role).provider(:sensuctl) do
  ...
  describe 'self.instances' do
    it 'should create instances' do
      allow(@provider).to receive(:sensuctl_list).with('cluster-role').and_return(my_fixture_read('cluster_role_list.json'))
  ...
  describe 'create' do
    it 'should create a cluster_role' do
      ...
      expect(@resource.provider).to receive(:sensuctl_create).with('ClusterRole', expected_spec)
