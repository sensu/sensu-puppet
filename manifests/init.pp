...
class sensu (
  ...
  Optional[Sensitive[String]]   $rabbitmq_password = undef,
  ...
  Optional[Sensitive[String]]   $api_password = undef,
  Variant[Undef,Integer,Pattern[/^(\d+)$/]] $api_ssl_port = undef,
  Optional[String]   $api_ssl_keystore_file = undef,
  Optional[Sensitive[String]]   $api_ssl_keystore_password = undef,
