...
class sensu (
  ...
  Variant[Undef,String,Sensitive] $rabbitmq_password = undef,
  ...
  Variant[Undef,String,Sensitive] $redis_password = undef,
  ...
  Variant[Undef,String,Sensitive] $api_password = undef,
  Variant[Undef,Integer,Pattern[/^(\d+)$/]] $api_ssl_port = undef,
  Optional[String]   $api_ssl_keystore_file = undef,
  Variant[Undef,String,Sensitive] $api_ssl_keystore_password = undef,
