...
class sensu (
  ...
  Variant[Undef,Sensitive,String] $rabbitmq_password = undef,
  ...
  Variant[Undef,Sensitive,String] $redis_password = undef,
  ...
  Variant[Undef,Sensitive,String] $api_password = undef,
  Variant[Undef,Integer,Pattern[/^(\d+)$/]] $api_ssl_port = undef,
  Optional[String]   $api_ssl_keystore_file = undef,
  Variant[Undef,Sensitive,String] $api_ssl_keystore_password = undef,
